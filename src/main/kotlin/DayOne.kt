...
object DayOne {
    fun runPartOne() {
        val result = partOne(inputA, inputB)
        println("Day1 Part1 result: $result")
    }

    fun runPartTwo() {
        val result = partTwo(inputA, inputB)
    ...
    private fun partOne(
        ...
        val aSorted = locationsA.sorted()
        val bSorted = locationsB.sorted()
        val totalDistanceBetweenLists =
            aSorted
                .zip(bSorted)
                .map { (a, b) ->
                    (a - b).absoluteValue
